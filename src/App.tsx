...
//import { Heading } from './assets/styles/ToDo';
...
export const App = () => {
    ...
    const addNew = () => {
        ...
        currentTasks.push({id: items.length + 1, name: itemInput, column: DO_IT});
    ...
    return ( 
        ...
        <div className="container">
            <img src={image} style={{ width: '100vw', height: '100vh', zIndex: -1, position: 'absolute' }}>
            </img> 
